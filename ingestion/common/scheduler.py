...
from ingestion.jobs import (
    ...
    sync_player_clutch_stats,
    sync_player_defensive_tracking,
    sync_player_hustle_stats,
    sync_player_on_off_stats,
    sync_player_play_types,
    sync_player_shot_locations,
