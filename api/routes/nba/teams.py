...
from api.request_params import TeamIdPath
...
def get_team_profile(team_id: TeamIdPath, db: Session = Depends(get_db)) -> TeamProfileResponse:
...
def get_team_lineups(team_id: TeamIdPath, db: Session = Depends(get_db)) -> TeamLineupsResponse:
