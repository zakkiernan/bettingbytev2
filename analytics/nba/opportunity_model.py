...
class PregameOpportunityModelConfig:
    ...
    context_minutes_vacated_factor: float = 0.032
    context_minutes_vacated_cap: float = 1.5
    context_usage_vacated_factor: float = 0.12
    context_usage_vacated_cap: float = 0.02
    context_touch_vacated_factor: float = 0.048
    context_touch_vacated_cap: float = 3.2
    context_usage_missing_teammate_bonus: float = 0.004
    context_primary_ballhandler_usage_bonus: float = 0.005
    context_primary_ballhandler_touches_bonus: float = 1.5
    context_primary_ballhandler_passes_bonus: float = 1.5
    context_frontcourt_minutes_bonus: float = 0.55
    role_replacement_minutes_factor: float = 0.045
    role_replacement_minutes_cap: float = 2.0
    role_replacement_usage_factor: float = 0.07
    role_replacement_usage_cap: float = 0.016
    role_replacement_touches_factor: float = 0.032
    role_replacement_touches_cap: float = 2.8
    role_replacement_passes_factor: float = 0.032
    role_replacement_passes_cap: float = 2.4
    absence_impact_minutes_factor: float = 0.0
    absence_impact_minutes_cap: float = 0.0
    absence_impact_usage_factor: float = 0.0
    absence_impact_usage_cap: float = 0.0
    absence_impact_touches_factor: float = 0.0
    absence_impact_touches_cap: float = 0.0
    absence_impact_passes_factor: float = 0.0
    absence_impact_passes_cap: float = 0.0
    absence_impact_confidence_floor: float = 0.50
    official_team_injury_minutes_bonus_cap: float = 3.2
    official_team_injury_start_rate_bonus_cap: float = 0.07
    official_team_injury_touch_bonus_per_minute: float = 0.5
    official_team_injury_pass_bonus_per_minute: float = 0.32
    ...
    projected_unavailable_minutes_scale: float = 0.14
    projected_unavailable_usage_scale: float = 0.28
    projected_unavailable_touches_scale: float = 0.20
    official_unavailable_minutes_cap: float = 0.8
