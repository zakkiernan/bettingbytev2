...
class PregameOpportunityModelConfig:
    ...
    context_minutes_vacated_factor: float = 0.04
    context_minutes_vacated_cap: float = 2.0
    context_usage_vacated_factor: float = 0.15
    context_usage_vacated_cap: float = 0.025
    context_touch_vacated_factor: float = 0.06
    context_touch_vacated_cap: float = 4.0
    context_usage_missing_teammate_bonus: float = 0.005
    context_primary_ballhandler_usage_bonus: float = 0.006
    context_primary_ballhandler_touches_bonus: float = 2.0
    context_primary_ballhandler_passes_bonus: float = 2.0
    context_frontcourt_minutes_bonus: float = 0.7
    role_replacement_minutes_factor: float = 0.055
    role_replacement_minutes_cap: float = 2.5
    role_replacement_usage_factor: float = 0.09
    role_replacement_usage_cap: float = 0.02
    role_replacement_touches_factor: float = 0.04
    role_replacement_touches_cap: float = 3.5
    role_replacement_passes_factor: float = 0.04
    role_replacement_passes_cap: float = 3.0
    ...
    official_team_injury_minutes_bonus_cap: float = 4.0
    official_team_injury_start_rate_bonus_cap: float = 0.09
    official_team_injury_touch_bonus_per_minute: float = 0.6
    official_team_injury_pass_bonus_per_minute: float = 0.4
    ...
    projected_unavailable_minutes_scale: float = 0.18
    projected_unavailable_usage_scale: float = 0.35
    projected_unavailable_touches_scale: float = 0.25
    official_unavailable_minutes_cap: float = 1.0
