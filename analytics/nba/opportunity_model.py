...
class PregameOpportunityModelConfig:
    ...
    absence_impact_minutes_factor: float = 0.15
    absence_impact_minutes_cap: float = 3.0
    absence_impact_usage_factor: float = 0.10
    absence_impact_usage_cap: float = 0.02
    absence_impact_touches_factor: float = 0.08
    absence_impact_touches_cap: float = 3.0
    absence_impact_passes_factor: float = 0.06
    absence_impact_passes_cap: float = 2.0
